...
// PersistenceManager class is responsible for handling the persistence of
// journal entries
...
int main() {
  ...
  // Attempt to save the journal directly (commented out to demonstrate the use
  // of PersistenceManager) journal.save("diary.txt");
